...
int main( )
{
 ...
 system("cls");
     ...
     DatosP paciente8 = {"Ramirez", "Jose", "890123456", 20,"tiroide" };
    
   
    DatosP Arreglo1[] = { paciente1,  paciente2, paciente3, paciente4, paciente5};
    DatosP Arreglo2[] = { paciente6,  paciente7, paciente8 };
 ...
 int tamasecundario[]= {5,3} ;
 int  *punterotama2 = tamasecundario ;

 imprimirInfo ( Obra_sociales , 2 , punterotama2 ) ;
